// Copyright 2015 The nowon Authors
// This file is part of nowon.
//
// nowon is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
// the Free Software Foundation, either version 3 of the License, or
// (at your option) any later version.
//
// nowon is distributed in the hope that it will be useful,
// but WITHOUT ANY WARRANTY; without even the implied warranty of
// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
// GNU General Public License for more details.
//
// You should have received a copy of the GNU General Public License
// along with nowon. If not, see <http://www.gnu.org/licenses/>.
...
import (
	...
	"github.com/tissazak/ethash"
	"github.com/tissazak/nowon/accounts"
	"github.com/tissazak/nowon/common"
	"github.com/tissazak/nowon/core"
	"github.com/tissazak/nowon/core/state"
	"github.com/tissazak/nowon/core/types"
	"github.com/tissazak/nowon/crypto"
	"github.com/tissazak/nowon/eth"
	"github.com/tissazak/nowon/ethdb"
	"github.com/tissazak/nowon/event"
	"github.com/tissazak/nowon/logger"
	"github.com/tissazak/nowon/logger/glog"
	"github.com/tissazak/nowon/miner"
	"github.com/tissazak/nowon/node"
	"github.com/tissazak/nowon/p2p/discover"
	"github.com/tissazak/nowon/p2p/nat"
	"github.com/tissazak/nowon/pow"
	"github.com/tissazak/nowon/whisper"
...
func MakeEtherbase(accman *accounts.Manager, ctx *cli.Context) common.Address {
	account,err := MakeAddress(accman,"7d0a374a3ac2ecf5bb7901a67c0e95873d6b8267")
	if err != nil {
        }
...
func logChainConfiguration(ctx *cli.Context, config *core.SufficientChainConfig) {
	...
	glog.V(logger.Info).Infof("Starting Geth Nowon \x1b[32m%s\x1b[39m", ctx.App.Version)
	glog.V(logger.Info).Infof("Geth is configured to use Nowon blockchain: \x1b[32m%v\x1b[39m", config.Name)

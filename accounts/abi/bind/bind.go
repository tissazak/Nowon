...
//
// Detailed usage document and tutorial available on the nowon Wiki page:
// https://github.com/ethereum/nowon/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
...
import (
	...
	"github.com/tissazak/nowon/accounts/abi"

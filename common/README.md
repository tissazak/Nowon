...
[![Build
Status](https://travis-ci.org/tissazak/nowon.png?branch=master)](https://travis-ci.org/ethereum/nowon)

The common package contains the ethereum utility library.

# Installation

As a subdirectory the main nowon repository, you get it with
`go get github.com/tissazak/nowon`.
